...
export const mainMenu = [
    ...
    {
        path: `${currentAccount.username}/lists`,
        title: "Listeler",
        icon: {
            active: (
                <svg viewBox="0 0 24 24" width={26.25} height={26.25}>
    ...
    {
        path: `/${currentAccount.username}/communities`,
        title: "Topluluklar",
        icon: {
            active: (
                <svg viewBox="0 0 24 24" width={26.25} height={26.25}>
...
export const moreIcon = <svg viewBox="0 0 24 24" width={26.25} height={26.25}>
    <path fill="#e7e9ea"
...
export const moreItems = [
    ...
    },
    {
        ...
        subItems: [
            {
                path: "https://analytics.twitter.com/",
                title: "İstatistikler",
                icon: (
                    <svg width={18.750} height={18.750} viewBox="0 0 24 24">
                        <path fill="#e7e9ea"
    ...
    },
    {
        ...
        subItems: [
            {
                path: "https://ads.twitter.com/?ref=gl-tw-tw-twitter-ads-rweb",
                title: "Reklamlar",
                icon: (
                    <svg width={18.750} height={18.750} viewBox="0 0 24 24">
                        <path fill="#e7e9ea"
    ...
    },
    {
        ...
        subItems: [
            ...
            {
                path: "https://support.twitter.com/",
            ...
            },
            {
                ...
                title: "Görünüm",
                icon: (
                    <svg viewBox="0 0 24 24" width={18.750} height={18.750}>
                        <path
                            fill="#e7e9ea"
