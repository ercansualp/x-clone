...
export default function Messages() {
    ...
    return (
        <div className={classNames("bg-[color:var(--background-primary)] w-[400px] shadow-box fixed bottom-0 right-5 rounded-t-2xl transition-all max-h-[530px]", {
            "h-[80vh]": showMessages,
            "h-[53px]": !showMessages,
        })}>
            <div
                onClick={handleClick}
                className="font-bold leading-6 text-xl text-[color:var(--color-base)] flex justify-between items-center px-4 h-[53px] cursor-pointer"
            >
                <div>Mesajlar</div>
                <div className="flex items-center">
                    <button id="view-msgs-btn" className="w-9 h-9 flex justify-center items-center rounded-full hover:bg-[color:var(--background-secondary)] transition-colors">
                    ...
                    <button onClick={handleClick} className="w-9 h-9 flex justify-center items-center rounded-full hover:bg-[color:var(--background-secondary)] transition-colors">
